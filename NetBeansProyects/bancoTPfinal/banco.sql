...
--
-- Estructura de tabla para la tabla `empleados_categorias`
--
...
--
-- Volcado de datos para la tabla `empleados_categorias`
--

INSERT INTO `empleados_categorias` (`id`, `nombre_categoria`) VALUES
(1, 'Gerente'),
(2, 'Administrativo'),
(3, 'Cajero');
...
CREATE TABLE `tipo_operaciones` (
  `id` int(11) NOT NULL,
  `nombre_operacion` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tipo_operaciones` (`id`, `nombre_operacion`) VALUES
(1, 'Cambio Moneda'),
(2, 'Prestamos'),
(3, 'Seguro de vida'),
(4, 'Seguro de Hogar'),
(5, 'Seguro de Vehiculo');
...
INSERT INTO `usuarios` (`id`, `usuario_nombre`, `clave`, `dni`, `acceso`) VALUES
...
--
-- Indices de la tabla `empleados_categorias`
--
ALTER TABLE `empleados_categorias`
  ADD PRIMARY KEY (`id`);
